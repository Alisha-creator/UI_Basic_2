package alisha.digipodium.ui_basic_2;
...
public class FirstFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        imgShare.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i= ShareCompat.IntentBuilder.from(getActivity()).setType("text/plain").setText("Not Sharing real stuff").setSubject("Sharing is caring").getIntent();
                startActivity(i);
            }
        });
